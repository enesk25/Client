...
void initapp()
{
	...
	PyModule_AddIntConstant(poModule, "ENABLE_ITEM_ATTR_COSTUME", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_ITEM_ATTR_COSTUME", 0);
#endif
...
#ifdef ENABLE_EXTEND_EQUIPMENT_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_EXTEND_EQUIPMENT_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_EXTEND_EQUIPMENT_SYSTEM", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_SORT_INVENTORY_ITEMS", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SORT_INVENTORY_ITEMS", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_LEVEL_SHOW_HIDE", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_LEVEL_SHOW_HIDE", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_FONT_CHANGE", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_FONT_CHANGE", 0);
#endif

#ifdef ENABLE_NEW_ACTIONS
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_ACTIONS", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_ACTIONS", 0);
#endif
...
#ifdef ENABLE_NEW_BONUS
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_BONUS", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_BONUS", 0);
#endif
...
#ifdef ENABLE_GREEN_ATTRIBUTE_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_GREEN_ATTRIBUTE_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_GREEN_ATTRIBUTE_SYSTEM", 0);
#endif

#ifdef ENABLE_BASIC_ITEM_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_BASIC_ITEM_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_BASIC_ITEM_SYSTEM", 0);
#endif

#ifdef ENABLE_DRAGON_BONE_EFFECTS
	PyModule_AddIntConstant(poModule, "ENABLE_DRAGON_BONE_EFFECTS", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_DRAGON_BONE_EFFECTS", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_SMITH_EFFECT_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SMITH_EFFECT_SYSTEM", 0);
#endif
...
#ifdef ENABLE_WHISPER_ALERT
	PyModule_AddIntConstant(poModule, "ENABLE_WHISPER_ALERT", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_WHISPER_ALERT", 0);
#endif
...
#ifdef ENABLE_HIDE_OBJECTS_OPTION
	PyModule_AddIntConstant(poModule, "ENABLE_HIDE_OBJECTS_OPTION",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_HIDE_OBJECTS_OPTION",	0);
#endif
...
#ifdef ENABLE_METINSTONE_MINIMAP
	PyModule_AddIntConstant(poModule, "ENABLE_METINSTONE_MINIMAP", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_METINSTONE_MINIMAP", 0);
#endif
...
#ifdef ENABLE_ONLINE_GUILD_LEADERS
	PyModule_AddIntConstant(poModule, "ENABLE_ONLINE_GUILD_LEADERS", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_ONLINE_GUILD_LEADERS", 0);
#endif

#ifdef ENABLE_AUTO_GUILD_WAR_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_AUTO_GUILD_WAR_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_AUTO_GUILD_WAR_SYSTEM", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_GUILD_SPY_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_GUILD_SPY_SYSTEM", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_GUILD_NOTICE_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_GUILD_NOTICE_SYSTEM", 0);
#endif

#ifdef ENABLE_WAR_KILL_NOTICE
	PyModule_AddIntConstant(poModule, "ENABLE_WAR_KILL_NOTICE", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_WAR_KILL_NOTICE", 0);
#endif
...
#ifdef ENABLE_GM_MINIMAP_TELEPORT
	PyModule_AddIntConstant(poModule, "ENABLE_GM_MINIMAP_TELEPORT", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_GM_MINIMAP_TELEPORT", 0);
#endif
...
#ifdef ENABLE_EXP_BLOCK_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_EXP_BLOCK_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_EXP_BLOCK_SYSTEM", 0);
#endif

#ifdef ENABLE_DUEL_BLOCK_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_DUEL_BLOCK_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_DUEL_BLOCK_SYSTEM", 0);
#endif

#if defined(ENABLE_PICKUP_FILTER_SYSTEM)
	PyModule_AddIntConstant(poModule, "ENABLE_PICKUP_FILTER_SYSTEM", true);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_PICKUP_FILTER_SYSTEM", false);
#endif

#ifdef ENABLE_FAST_TRANSACTIONS
	PyModule_AddIntConstant(poModule, "ENABLE_FAST_TRANSACTIONS", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_FAST_TRANSACTIONS", 0);
#endif

#ifdef ENABLE_MULTIPLE_BUY
	PyModule_AddIntConstant(poModule, "ENABLE_MULTIPLE_BUY", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_MULTIPLE_BUY", 0);
#endif

#ifdef ENABLE_MESSENGER_TEAM_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_MESSENGER_TEAM_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_MESSENGER_TEAM_SYSTEM", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_YANG_LIMIT_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_YANG_LIMIT_SYSTEM", 0);
#endif

#ifdef ENABLE_ITEM_COUNT_LIMIT_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_ITEM_COUNT_LIMIT_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_ITEM_COUNT_LIMIT_SYSTEM", 0);
#endif
...
#ifdef ENABLE_NEW_FOLLOW_AND_ATTACK
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_FOLLOW_AND_ATTACK", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_FOLLOW_AND_ATTACK", 0);
#endif

#ifdef ENABLE_BRAVERY_CAPE_RENEWAL
	PyModule_AddIntConstant(poModule, "ENABLE_BRAVERY_CAPE_RENEWAL", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_BRAVERY_CAPE_RENEWAL", 0);
#endif
...
#ifdef ENABLE_CHATTING_WINDOW_RENEWAL
...
#ifdef ENABLE_EXP_LOG
	PyModule_AddIntConstant(poModule, "ENABLE_EXP_LOG", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_EXP_LOG", 0);
#endif

#ifdef ENABLE_PM_IN_GLOBAL_CHAT
	PyModule_AddIntConstant(poModule, "ENABLE_PM_IN_GLOBAL_CHAT", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_PM_IN_GLOBAL_CHAT", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_QUICK_CHEST_OPEN", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_QUICK_CHEST_OPEN", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_FAST_SKILLBOOK_READ_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_FAST_SKILLBOOK_READ_SYSTEM", 0);
#endif

#ifdef ENABLE_FAST_SOULSTONE_READ_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_FAST_SOULSTONE_READ_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_FAST_SOULSTONE_READ_SYSTEM", 0);
#endif

#ifdef ZIRH_EFEKT
	PyModule_AddIntConstant(poModule, "ZIRH_EFEKT", 1);
#else
	PyModule_AddIntConstant(poModule, "ZIRH_EFEKT", 0);
#endif

#ifdef SILAH_EFEKT
	PyModule_AddIntConstant(poModule, "SILAH_EFEKT", 1);
#else
	PyModule_AddIntConstant(poModule, "SILAH_EFEKT", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_EXCHANGE_RENEWAL",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_EXCHANGE_RENEWAL",	0);
#endif

#if defined(ENABLE_CHEST_DROP_INFO)
	PyModule_AddIntConstant(poModule, "ENABLE_CHEST_DROP_INFO", true);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_CHEST_DROP_INFO", false);
#endif
}